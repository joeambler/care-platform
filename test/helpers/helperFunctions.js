...
module.exports = {
  executeActions: function executeActions (
    variables, actions, finalCallback, i = 0) {
    variables.responses = variables.responses === undefined
      ? []
      : variables.responses
    ...
    if (actions.length === 0) {
      ...
      currentAction.action(response,
        () => executeActions(variables, actions, finalCallback, i))
    }
  },
