...
module.exports = {
  ...
  clientTests: function (test) {
    ...
    test.equals(this.responses[1].json.name.firstNames,
      ClientManagementActions.getTestClient().name.firstNames,
      'Client return should match what was posted')
    test.equals(this.responses[2].status, 200,
      'Client should be deleted successfully')
    test.equals(this.responses[3].status, 404,
      'Deleted client should not be 404-Not found')
    test.done()
  },
}
